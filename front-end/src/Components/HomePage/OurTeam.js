...
const OurTeam = () => {
  ...
  const STAFFBIOS = {
    ...
    tom: "I’m a lifelong technophile, having been lucky enough to get a computer and NES into my home at the age of 2. Growing up, I’ve been fortunate to see the internet evolve from its beginnings of non-interlinked services such as PC-Link and CompuServe to where we are today. I’m glad to have found Pursuit, as the structure and pacing were exactly what I was looking for and failing to find through traditional school and personal study. ",
    kalilah:
      "My name is Kalilah Clarke. In school my favorite subject was Mathematics because I loved problem solving, I viewed math as a puzzle. I began my career as a Full-Stack Developer because of an Alumni Fellow who recognized those same qualities in web-development. I currently work as an Educator and Supervisor training others to optimally support and communicate with Middle School students  and though I love it, Pursuit has broken the ceiling as I pursue self development.",
    adnan:
    ...
    sabrina:
      "I am a currently a professional services’ Provider at the Mexican Consulate in New York and also I am studying Web Development in pursuit. Before I joined pursuit. I studied Computer Science in Mexico where I learned how to code in Java and Mysql. After I finished college , I came to the USA and I started my journey in pursuit. I feel really happy for that decision because now I know how to code in JavaScript , HTML, CSS and Postgres. When I am not coding, I like to read the newspaper and go to the park with my daughter. My biggest dream is to become a Web Developer and work for a big company where I can put my skills to use and gain more experience.",
